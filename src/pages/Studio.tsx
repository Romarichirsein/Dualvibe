...
export default function Studio({ lang }: StudioProps) {
  ...
  const categories = [
    { id: 'music' as CategoryId, icon: Music, title: t.musicCustom, desc: t.musicDesc, color: 'from-pink-500 to-rose-500' },
    { id: 'photo' as CategoryId, icon: Camera, title: t.photoCustom, desc: t.photoDesc, color: 'from-blue-500 to-cyan-500' },
    { id: 'video' as CategoryId, icon: Video, title: t.videoCustom, desc: t.videoDesc, color: 'from-purple-500 to-indigo-500' },
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16 relative">
          <motion.div 
            ...
            className="inline-flex items-center gap-2 glass px-4 py-2 rounded-full text-pink-500 font-bold text-sm mb-6"
          >
          ...
          <div className="lg:col-span-4 space-y-4">
            {categories.map((cat) => (
              <motion.button
                ...
                className={`w-full text-left p-6 rounded-[2rem] transition-all flex items-center gap-6 group relative overflow-hidden ${
                  activeCategory === cat.id 
                    ? 'glass border-pink-500/50 shadow-xl' 
              ...
              >
                ...
                {activeCategory === cat.id && (
                  <ChevronRight className="w-5 h-5 ml-auto text-pink-500" />
                )}
              </motion.button>
            ))}
          </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
                  <div className="space-y-4">
                    ...
                    <textarea 
                      ...
                      className="w-full glass bg-white/5 border border-white/10 rounded-[2rem] p-6 h-48 outline-none focus:border-pink-500/50 transition-all resize-none text-lg"
                    />
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    <div className="space-y-4">
                      ...
                      <input 
                        ...
                        className="w-full glass bg-white/5 border border-white/10 rounded-2xl px-6 py-4 outline-none focus:border-pink-500/50 transition-all"
                      />
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="relative group/upload">
                        ...
                        />
                        <div className="glass bg-white/5 border-2 border-dashed border-white/10 rounded-2xl p-4 flex items-center justify-center gap-3 group-hover/upload:border-pink-500/50 transition-all">
                          <Upload className="w-5 h-5 opacity-40 group-hover/upload:text-pink-500" />
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    type="submit"
                    className="w-full py-6 bg-gradient-to-r from-pink-500 via-purple-600 to-indigo-600 text-white rounded-[2rem] font-extrabold text-xl shadow-xl shadow-pink-500/20 flex items-center justify-center gap-4 transition-all group"
                  >
          ...
          >
            ...
            <Link to="/shop">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-10 py-4 bg-pink-500 text-white rounded-2xl font-bold flex items-center gap-3 mx-auto relative z-10 shadow-xl shadow-pink-500/20"
              >
