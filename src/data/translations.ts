export const TRANSLATIONS = {
  fr: {
    ...
    musicFormDesc: "Pour concevoir l'univers sonore parfait, parlez-nous de votre vision. Choisissez la catégorie et précisez votre histoire.",
    musicCategory: "Catégorie principale",
    musicSubCategory: "Précisez le type d'événement",
  ...
  en: {
    ...
    musicFormDesc: "To design the perfect sound universe, tell us about your vision. Choose the category and specify your story.",
    musicCategory: "Main Category",
    musicSubCategory: "Specify Event Type",
